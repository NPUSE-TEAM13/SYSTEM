                ...
                <form class="layui-form">
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-form-mid layui-word-aux">
                          <span class="x-red">*</span>请填阿拉伯数字
                      </div>
                  </div>
                  <div class="layui-form-item">
                      <label class="layui-form-label"><span class="x-red">*</span>请假类型</label>
                      <div class="layui-input-block">
                        <input type="checkbox" name="like1[write]" lay-skin="primary" title="病假" checked="">
                        <input type="checkbox" name="like1[read]" lay-skin="primary" title="事假">
                        <input type="checkbox" name="like1[write]" lay-skin="primary" title="公假" checked="">
                      </div>
                  </div>
                  <div class="layui-form-item">
