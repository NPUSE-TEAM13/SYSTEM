...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="<%=request.getContextPath() %>/adminLogin">职员综合服务管理系统</a></div>
        <div class="left_open">
        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="<%=request.getContextPath() %>/staffManage/setStaffID">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>新职工管理</cite>
                       ...
                       <li>
                        <a _href="<%=request.getContextPath()%>/ApplicationManage/applicationEdit">
	                        <i class="iconfont">&#xe6a7;</i>
	                        <cite>入职申请审核</cite>
                        </a>
                     ...
                     <li>
                        <a _href="<%=request.getContextPath()%>/staffManage/stuPicture">
	                        <i class="iconfont">&#xe6a7;</i>
	                        <cite>员工数量统计</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="<%=request.getContextPath() %>/officeManage/handelOfficeApply">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>办公室申请处理</cite>
                        </a>
                    </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath() %>/courseManage/jcInformation">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>培训信息</cite>
                        </a>
                    </li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath() %>/courseManage/jcCheck">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>课程审定</cite>
                        </a>
                    </li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath() %>/courseManage/jcPurchase">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>课程征订</cite>
                        </a>
                    </li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath() %>/courseManage/jcProvide">
                            <i class="iconfont">&#xe6a7;</i><cite>课程发布</cite></a>
                    </li>
                </ul>
            </li>
            <li>
